...
heatmap.
* **Casual riders** tend to heavily use an eBike on Saturdays but the casual 
riders heatmap also shows that eBike usage is high **Wednesday to Friday** 
...
This section will evaluate the riding behavior of 
